...
function createSyncState({ defaultValue, key, storage, serialize = JSON.stringify, deserialize = stringValue => JSON.parse(stringValue || 'null'), onInit, onUpdate, }) {
    if (storage && !key) {
    ...
    function setSyncValue(newValue) {
        ...
        callUpdaters(value);
        setTimeout(() => onUpdate === null || onUpdate === void 0 ? void 0 : onUpdate(value), 0);
